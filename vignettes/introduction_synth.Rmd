...
## Optional: 
## Save data objects for downstream analysis
## (Commented out in the vignette, because we don't use it) #
# Saving as rda for CRAN preferences
#save(M, file=paste0(datapath,
#                    "EB_M.Rda"))
